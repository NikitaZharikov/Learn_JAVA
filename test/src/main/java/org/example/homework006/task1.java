...
public class task1 {
    public static void main(String[] args) {
        laptop lap1 = new laptop("A5", 1, "Acer");
        lap1.setColor("black");
        lap1.setHDD(700);
        lap1.setOS("Windows");
        lap1.setRAM(8);

        laptop lap2 = new laptop("Redmibook Pro 14", 2, "Xiaomi");
        lap2.setColor("white");
        lap2.setHDD(1000);
        lap2.setOS("Windows");
        lap2.setRAM(8);

        laptop lap3 = new laptop("Pulse GL66", 3, "MSI");
        lap3.setColor("black");
        lap3.setHDD(900);
        lap3.setOS("Windows");
        lap3.setRAM(16);

        laptop lap4 = new laptop("Pavilion", 4, "HP");
        lap4.setColor("black");
        lap4.setHDD(700);
        lap4.setOS("Linux");
        lap4.setRAM(8);

        laptop lap5 = new laptop("MagicBook X 15", 5, "Honor");
